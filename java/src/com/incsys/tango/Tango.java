...
//1015  	FORMAT(1X,I5,8G12.4/6X,8G12.4)
			if (_wrtr != null)
			{
				_wrtr.printf(
						...
						i + 1, _cb.pbase[i], _cb.h[i], _cb.r[i], _cb.xl[i],
						_cb.xd[i], _cb.xd1[i], _cb.xq[i], _cb.xq1[i]);
				_wrtr.printf(" %5c %12.4g%12.4g%12.4g%12.4g%12.4g,%s\n", ' ',
						_cb.td1[i], _cb.tq1[i], _cb.damp[i], _cb.c1[i],
						_cb.c2[i], gu.getName());
			}
...
//		new Plot(_cb, rdr, _wrtr).plot();
	...
	static public void main(String[] args) throws Exception
	{
		...
		PrintWriter out = (outname == null) ? null :
	...
	public static void showHelp()
	{
		...
		System.out.println("\t--event event_csv_file --resultdir directory_for_unit_results ");
		System.out.println("\t[ --output file_name] [ --help ]");
	}
